...
public class LoginService {
    ...
    public String getAuthorizationUrl() {
        String kakaoAuthrizationUrl = "https://kauth.kakao.com/oauth/authorize?"
                + "client_id=" + kakaoOauthClientId
                + "&redirect_uri=" + kakaoRedirectUri
                + "&response_type=code";
        return kakaoAuthrizationUrl;
    }

    public KakaoTokenInfoDto getToken(String authorize_code) throws IOException {
    ...
    public KakaoUserInfoDto getKakaoUserInfo(String accessToken) throws IOException {
        ...
        KakaoUserInfoDto kakaoUserInfoResponse = KakaoUserInfoDto.builder()
